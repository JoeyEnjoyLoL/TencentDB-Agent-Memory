/**
 * Cursor adapter CLI — routes `hook` / `worker` / `mcp` / install commands
 * for the memory-tencentdb-cursor binary.
 *
 * Boundary: argv parsing and process I/O. Domain work is delegated to
 * hooks, worker, MCP, installer, and spike modules.
 */
