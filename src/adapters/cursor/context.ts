/**
 * Session context builder — assembles Persona, scene navigation, and the
 * memory tool guide for Cursor sessionStart injection.
 *
 * Boundary: reads dataDir files and returns additional_context text.
 * TOOL_GUIDE stays Chinese (agent-facing instructions).
 */
...
export async function buildSessionContext(
  ...
  try {
    ...
    // Missing Persona is normal for new users.
  }
