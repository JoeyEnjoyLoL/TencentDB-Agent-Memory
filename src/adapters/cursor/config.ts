/**
 * Cursor adapter config — resolves paths, Gateway URL, and timeouts from
 * environment variables with safe numeric fallbacks.
 *
 * Boundary: pure env/path resolution. No filesystem or network I/O.
 */
