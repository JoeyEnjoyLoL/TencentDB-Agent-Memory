/**
 * Top-level session markers — hash-named files that record which Cursor
 * conversations were classified as foreground by sessionStart.
 *
 * Boundary: empty marker files under rootDir/sessions only. No IDs or
 * message bodies are stored on disk.
 */
