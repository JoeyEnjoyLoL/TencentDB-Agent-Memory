/**
 * Cursor installer — safely merges Hooks, MCP, and Rule into user or
 * project `.cursor` config without clobbering foreign entries.
 *
 * Boundary: filesystem install/uninstall only. Ownership is gated by
 * CURSOR_ADAPTER_MARKER; Rule/TOOL_GUIDE bodies stay Chinese for agents.
 */
