/**
 * Cursor MCP bridge — registers read-only L1/L0 search tools that proxy
 * to TDAI Gateway over stdio.
 *
 * Boundary: tool registration + Gateway search requests only. No capture,
 * session-end, or local memory writes.
 */
